...
// Issue #14 (Sam v5, reshot in v8): the roster is his 23 ILLUSTRATED avatars, one file
...
export const AVATARS = [
  ...
  'angel', 'spectre', 'wolf', 'alien', 'dragon',
  'elemental', 'knight', 'ninja', 'robot', 'spider',
  'archer', 'demon', 'wizzard',
];
...
export const ITEMS = {
  ...
  // v20.1 (Ju's correction): the 25% ladder is PERSONAL and PERMANENT — your
  // own costs[level] rung, game-long (items never reset, so the price never
  // falls back to 12; test-locked). The v20 shared ladder is reverted.
  angel: { name: 'Guardian Angel',
            costs: Array.from({ length: 9 }, (_, i) => Math.round(12 * 1.25 ** i)),
            maxLevel: 9,
            desc: 'Cheat death, secretly.',
            long: 'The blow that would kill you is refused: you stand back up where you fell with half your maximum health, and your killer is credited with nothing. At most ONE save per round, and a save consumes one purchase — each of YOUR repurchases costs 25% more, for the whole game, the price never falls back. No other player can see that you own it.' },
};
...
export const OPTIMS = {
  ...
  POOL: {
    ...
    // v9 (Ju approved the agent's 8, lavapush at 20% by his ruling)
    swift:     { icon: '🥾', name: 'Swift Feet',  mult: 1.10,
                 desc: 'You move 10% faster.' },
    sharp:     { icon: '🗡️', name: 'Sharp Ball',  mult: 1.10,
                 desc: 'Your balls deal 10% more damage.' },
    longthrow: { icon: '🎯', name: 'Long Throw',  mult: 1.10,
                 desc: 'Your fireball flies 10% further before fizzling.' },
    fastball:  { icon: '☄️', name: 'Fast Ball',   mult: 1.10,
                 desc: 'Your balls fly 10% faster.' },
    tough:     { icon: '❤️', name: 'Tough Hide',  add: 10,
                 desc: '+10 max hp, healed right now.' },
    fireproof: { icon: '🧯', name: 'Fireproof Skin', mult: 0.75,
                 desc: 'Lava deals you 25% less damage.' },
    headhunter:{ icon: '🏹', name: 'Headhunter',  add: 1,
                 desc: '+1 extra gold for every kill.' },
    lavapush:  { icon: '🌊', name: 'Tidal Ball',  mult: 1.20,
                 desc: 'Your balls push enemies who are IN the lava 20% harder.' },
    // v9 (Ju's own four)
    decoyclone:{ icon: '👥', name: 'Extra Mirage', add: 1, minRound: 6,
                 desc: 'Your Decoy spawns one more clone.' },
    roundshield:{ icon: '🛡️', name: 'Round Ward', frac: 0.10,
                 desc: 'Start every round with a shield worth 10% of your max hp. It blocks damage only, never push.' },
    small:     { icon: '🐁', name: 'Slim Silhouette', mult: 0.85,
